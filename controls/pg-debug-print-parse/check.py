#!/usr/bin/env python3
"""Control: pg-debug-print-parse — Ensure debug_print_parse is disabled"""
...
CONTROL_ID = "pg-debug-print-parse"
TITLE = "Ensure debug_print_parse is disabled"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET debug_print_parse = 'off';
SELECT pg_reload_conf();"""

QUERY = """SHOW debug_print_parse;"""

ASSERTIONS = [
    ("debug_print_parse", "equals", "off"),
]
