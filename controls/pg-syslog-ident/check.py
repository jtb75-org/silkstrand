#!/usr/bin/env python3
"""Control: pg-syslog-ident — Ensure the program name for PostgreSQL syslog messages is correct"""
...
CONTROL_ID = "pg-syslog-ident"
TITLE = "Ensure the program name for PostgreSQL syslog messages is correct"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET syslog_ident = 'proddb';
SELECT pg_reload_conf();"""

QUERY = """SHOW syslog_ident;"""

ASSERTIONS = [
    ("syslog_ident", "pattern_match", ".+"),
]
