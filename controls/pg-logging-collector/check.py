#!/usr/bin/env python3
"""Control: pg-logging-collector — Ensure the logging collector is enabled"""
...
CONTROL_ID = "pg-logging-collector"
TITLE = "Ensure the logging collector is enabled"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET logging_collector = 'on';
SELECT pg_reload_conf();"""

QUERY = """SHOW logging_collector;"""

ASSERTIONS = [
    ("logging_collector", "equals", "on"),
]
