#!/usr/bin/env python3
"""Control: pg-weak-ssl-ciphers — Ensure Weak SSL/TLS Ciphers Are Disabled"""
...
CONTROL_ID = "pg-weak-ssl-ciphers"
TITLE = "Ensure Weak SSL/TLS Ciphers Are Disabled"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET ssl_ciphers = 'HIGH:MEDIUM:+3DES:!aNULL';
SELECT pg_reload_conf();"""

QUERY = """SHOW ssl_ciphers;"""

ASSERTIONS = [
    ("ssl_ciphers", "pattern_not_match", "(RC4|DES|MD5|NULL|EXPORT|aNULL|eNULL)"),
]
