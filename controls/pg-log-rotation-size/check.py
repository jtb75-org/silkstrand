#!/usr/bin/env python3
"""Control: pg-log-rotation-size — Ensure the maximum log file size is set correctly"""
...
CONTROL_ID = "pg-log-rotation-size"
TITLE = "Ensure the maximum log file size is set correctly"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET log_rotation_size = '100MB';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_rotation_size;"""

ASSERTIONS = [
    ("log_rotation_size", "pattern_match", ".+"),
]
