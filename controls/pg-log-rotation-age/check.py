#!/usr/bin/env python3
"""Control: pg-log-rotation-age — Ensure the maximum log file lifetime is set correctly"""
...
CONTROL_ID = "pg-log-rotation-age"
TITLE = "Ensure the maximum log file lifetime is set correctly"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET log_rotation_age = '1d';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_rotation_age;"""

ASSERTIONS = [
    ("log_rotation_age", "pattern_match", ".+"),
]
