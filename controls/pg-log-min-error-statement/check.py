#!/usr/bin/env python3
"""Control: pg-log-min-error-statement — Ensure the correct SQL statements generating errors are recorded"""
...
CONTROL_ID = "pg-log-min-error-statement"
TITLE = "Ensure the correct SQL statements generating errors are recorded"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_min_error_statement = 'error';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_min_error_statement;"""

ASSERTIONS = [
    ("log_min_error_statement", "in", ["debug5","debug4","debug3","debug2","debug1","info","notice","warning","error"]),
]
