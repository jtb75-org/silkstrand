#!/usr/bin/env python3
"""Control: pg-tls-enabled — Ensure TLS is enabled and configured correctly"""
...
CONTROL_ID = "pg-tls-enabled"
TITLE = "Ensure TLS is enabled and configured correctly"
SEVERITY = "high"
REMEDIATION = """Set ssl = on in postgresql.conf and restart PostgreSQL.
