#!/usr/bin/env python3
"""Control: pg-log-line-prefix — Ensure log_line_prefix is set correctly"""
...
CONTROL_ID = "pg-log-line-prefix"
TITLE = "Ensure log_line_prefix is set correctly"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_line_prefix = '%m [%p]: [%l-1] db=%d,user=%u ';
