#!/usr/bin/env python3
"""Control: pg-log-file-mode — Ensure the log file permissions are set correctly"""
...
CONTROL_ID = "pg-log-file-mode"
TITLE = "Ensure the log file permissions are set correctly"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_file_mode = '0600';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_file_mode;"""

ASSERTIONS = [
    ("log_file_mode", "equals", "0600"),
]
