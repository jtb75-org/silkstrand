#!/usr/bin/env python3
"""Control: pg-syslog-sequence-numbers — Ensure syslog messages are not suppressed"""
...
CONTROL_ID = "pg-syslog-sequence-numbers"
TITLE = "Ensure syslog messages are not suppressed"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET syslog_sequence_numbers = 'on';
SELECT pg_reload_conf();"""

QUERY = """SHOW syslog_sequence_numbers;"""

ASSERTIONS = [
    ("syslog_sequence_numbers", "equals", "on"),
]
