#!/usr/bin/env python3
"""Control: pg-log-disconnections — Ensure log_disconnections is enabled"""
...
CONTROL_ID = "pg-log-disconnections"
TITLE = "Ensure log_disconnections is enabled"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_disconnections = 'on';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_disconnections;"""

ASSERTIONS = [
    ("log_disconnections", "equals", "on"),
]
