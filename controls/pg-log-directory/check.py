#!/usr/bin/env python3
"""Control: pg-log-directory — Ensure the log file destination directory is set correctly"""
...
CONTROL_ID = "pg-log-directory"
TITLE = "Ensure the log file destination directory is set correctly"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_directory = 'log';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_directory;"""

ASSERTIONS = [
    ("log_directory", "pattern_match", ".+"),
]
