#!/usr/bin/env python3
"""Control: pg-log-min-messages — Ensure the correct messages are written to the server log"""
...
CONTROL_ID = "pg-log-min-messages"
TITLE = "Ensure the correct messages are written to the server log"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_min_messages = 'warning';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_min_messages;"""

ASSERTIONS = [
    ("log_min_messages", "in", ["debug5","debug4","debug3","debug2","debug1","info","notice","warning"]),
]
