#!/usr/bin/env python3
"""Control: pg-pgaudit — Ensure the PostgreSQL Audit Extension (pgAudit) is enabled"""
...
CONTROL_ID = "pg-pgaudit"
TITLE = "Ensure the PostgreSQL Audit Extension (pgAudit) is enabled"
SEVERITY = "medium"
REMEDIATION = """shared_preload_libraries = 'pgaudit'
...
ASSERTIONS = [
    ("shared_preload_libraries", "pattern_match", "pgaudit"),
]
