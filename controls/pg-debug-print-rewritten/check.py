#!/usr/bin/env python3
"""Control: pg-debug-print-rewritten — Ensure debug_print_rewritten is disabled"""
...
CONTROL_ID = "pg-debug-print-rewritten"
TITLE = "Ensure debug_print_rewritten is disabled"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET debug_print_rewritten = 'off';
SELECT pg_reload_conf();"""

QUERY = """SHOW debug_print_rewritten;"""

ASSERTIONS = [
    ("debug_print_rewritten", "equals", "off"),
]
