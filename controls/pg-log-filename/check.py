#!/usr/bin/env python3
"""Control: pg-log-filename — Ensure the filename pattern for log files is set correctly"""
...
CONTROL_ID = "pg-log-filename"
TITLE = "Ensure the filename pattern for log files is set correctly"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_filename = 'postgresql-%Y-%m-%d_%H%M%S.log';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_filename;"""

ASSERTIONS = [
    ("log_filename", "pattern_match", ".+"),
]
