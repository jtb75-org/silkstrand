#!/usr/bin/env python3
"""Control: pg-log-hostname — Ensure log_hostname is set correctly"""
...
CONTROL_ID = "pg-log-hostname"
TITLE = "Ensure log_hostname is set correctly"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET log_hostname = 'off';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_hostname;"""

ASSERTIONS = [
    ("log_hostname", "pattern_match", ".+"),
]
