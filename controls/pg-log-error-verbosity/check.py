#!/usr/bin/env python3
"""Control: pg-log-error-verbosity — Ensure log_error_verbosity is set correctly"""
...
CONTROL_ID = "pg-log-error-verbosity"
TITLE = "Ensure log_error_verbosity is set correctly"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET log_error_verbosity = 'default';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_error_verbosity;"""

ASSERTIONS = [
    ("log_error_verbosity", "in", ["default","verbose"]),
]
