#!/usr/bin/env python3
"""Control: pg-backend-runtime-parameters — Ensure backend runtime parameters are configured correctly"""
...
CONTROL_ID = "pg-backend-runtime-parameters"
TITLE = "Ensure backend runtime parameters are configured correctly"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET post_auth_delay = '0';
SELECT pg_reload_conf();"""

QUERY = """SHOW post_auth_delay;"""

ASSERTIONS = [
    ("post_auth_delay", "equals", "0"),
]
