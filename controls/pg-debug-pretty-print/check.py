#!/usr/bin/env python3
"""Control: pg-debug-pretty-print — Ensure debug_pretty_print is enabled"""
...
CONTROL_ID = "pg-debug-pretty-print"
TITLE = "Ensure debug_pretty_print is enabled"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET debug_pretty_print = 'on';
SELECT pg_reload_conf();"""

QUERY = """SHOW debug_pretty_print;"""

ASSERTIONS = [
    ("debug_pretty_print", "equals", "on"),
]
