#!/usr/bin/env python3
"""Control: pg-wal-archiving — Ensure WAL archiving is configured and functional"""
...
CONTROL_ID = "pg-wal-archiving"
TITLE = "Ensure WAL archiving is configured and functional"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET archive_mode = 'on';
ALTER SYSTEM SET archive_command = '<your command>';
# Restart PostgreSQL."""

QUERY = """SHOW archive_mode;"""

ASSERTIONS = [
    ("archive_mode", "in", ["on","always"]),
]
