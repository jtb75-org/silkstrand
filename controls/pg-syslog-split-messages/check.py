#!/usr/bin/env python3
"""Control: pg-syslog-split-messages — Ensure syslog messages are not lost due to size"""
...
CONTROL_ID = "pg-syslog-split-messages"
TITLE = "Ensure syslog messages are not lost due to size"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET syslog_split_messages = 'on';
SELECT pg_reload_conf();"""

QUERY = """SHOW syslog_split_messages;"""

ASSERTIONS = [
    ("syslog_split_messages", "equals", "on"),
]
