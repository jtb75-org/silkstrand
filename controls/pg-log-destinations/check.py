#!/usr/bin/env python3
"""Control: pg-log-destinations — Ensure the log destinations are set correctly"""
...
CONTROL_ID = "pg-log-destinations"
TITLE = "Ensure the log destinations are set correctly"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_destination = 'csvlog';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_destination;"""

ASSERTIONS = [
    ("log_destination", "pattern_match", "(stderr|csvlog|syslog|jsonlog|eventlog)"),
]
