#!/usr/bin/env python3
"""Control: pg-log-truncate-on-rotation — Ensure log_truncate_on_rotation is enabled"""
...
CONTROL_ID = "pg-log-truncate-on-rotation"
TITLE = "Ensure log_truncate_on_rotation is enabled"
SEVERITY = "medium"
REMEDIATION = """ALTER SYSTEM SET log_truncate_on_rotation = 'on';
SELECT pg_reload_conf();"""

QUERY = """SHOW log_truncate_on_rotation;"""

ASSERTIONS = [
    ("log_truncate_on_rotation", "equals", "on"),
]
