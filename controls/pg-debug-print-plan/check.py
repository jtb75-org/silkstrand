#!/usr/bin/env python3
"""Control: pg-debug-print-plan — Ensure debug_print_plan is disabled"""
...
CONTROL_ID = "pg-debug-print-plan"
TITLE = "Ensure debug_print_plan is disabled"
SEVERITY = "low"
REMEDIATION = """ALTER SYSTEM SET debug_print_plan = 'off';
SELECT pg_reload_conf();"""

QUERY = """SHOW debug_print_plan;"""

ASSERTIONS = [
    ("debug_print_plan", "equals", "off"),
]
