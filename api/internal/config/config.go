...
type Config struct {
	...
	BundlePublicBaseURL     string   // Public base URL for published bundle tarballs (homelab MinIO, e.g. https://downloads.silkstrand.io/agent/bundles — bundles nest under the agent route). Sets bundles.gcs_path when GCS is unset.
